export default {
	...
	HeroBanner: {
		set1: {
			title: "Unlimited access to movies, series and more.",
	...
	Accordion: {
		...
		item2: {
			...
			details: {
				p1: "Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from EUR7.99 to EUR11.99 a month. No extra costs, no contracts.",
			},
		},
		item3: {
